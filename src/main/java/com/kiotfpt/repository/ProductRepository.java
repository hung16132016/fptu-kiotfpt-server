...
public interface ProductRepository extends JpaRepository<Product, Integer> {
	...
	@Query(value = "SELECT * FROM kiotfpt_product WHERE kiotfpt_product.shop_id = :id", countQuery = "SELECT count(*) FROM kiotfpt_product WHERE kiotfpt_product.shop_id = :id", nativeQuery = true)
	...
	Page<Product> findByPriceRange(@Param("min_price") float min_price, @Param("max_price") float max_price,
			Pageable pageable);
